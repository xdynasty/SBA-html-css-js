  ...
  axios
    ...
    .then(({ data }) => {
      ...
      data.forEach((dog) => {
        ...
        let bredForContainerEle = $('<div>').appendTo(factsContainerEle);
        ...
        let breedGroupContainerEle = $('<div >').appendTo(factsContainerEle);
        ...
        let heightContainerEle = $('<div >').appendTo(factsContainerEle);
        ...
        let lifespanContainerEle = $('<div >').appendTo(factsContainerEle);
        ...
        let temperamentContainerEle = $('<div >').appendTo(factsContainerEle);
